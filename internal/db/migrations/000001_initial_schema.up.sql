-- DocStore VCS — single clean initial schema
-- Consolidates all previous migrations into one authoritative file.
...
-- repos: top-level namespace for multi-tenancy
CREATE TABLE repos (
...
CREATE TABLE documents (
    ...
    repo         TEXT NOT NULL DEFAULT 'default' REFERENCES repos (name)
);
...
-- Seed the default repo and main branch
INSERT INTO repos (name, created_by) VALUES ('default', 'system');
INSERT INTO branches (repo, name, head_sequence, base_sequence, status) VALUES ('default', 'main', 0, 0, 'active');
